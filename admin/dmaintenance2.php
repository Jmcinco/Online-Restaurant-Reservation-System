    ...
    <div class="sidebar shadow">
        ...
        <div class="sidebar-items">
            ...
            <a style="display: <?= $_SESSION['role'] !== 'superadmin' ? 'none' : '' ?>" data-bs-toggle="tooltip"
                ...
                <li><i class="fa-solid fa-users"></i> <span>Roles</span></li>
            </a>
            <a style="display: <?= $_SESSION['dmaintenance'] !== 'superadmin' ? 'none' : '' ?>" data-bs-toggle="tooltip"
                data-bs-placement="right" title="Reservation Table" href="dmaintenance.php">
