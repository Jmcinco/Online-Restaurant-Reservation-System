...
```
cd existing_repo
git remote add origin https://gitlab.com/markpaulocruz839/piggywings-updated.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/markpaulocruz839/piggywings-updated/-/settings/integrations)
